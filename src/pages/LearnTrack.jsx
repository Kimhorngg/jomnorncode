    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="max-w-[1450px] mx-auto px-6 py-10 space-y-8">
        ...
        >
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-[#112d4f]">
              <span className="text-[#ffa500]">HTML</span>{" "}
              មូលដ្ឋានសម្រាប់អ្នកចាប់ផ្តើម
            </h2>
        ...
        <div
          ...
          data-aos="fade-up"
        >
          <h3 className="text-xl font-bold text-[#112d4f] mb-2">សញ្ញាប័ត្រ</h3>
          ...
          <div className="border-4 border-yellow-600 rounded-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="mt-6 text-lg">Has completed all the lessons</p>

            <p className="mt-6 font-bold text-xl">Your Name</p>
          </div>
        </div>
      </div>
    </div>

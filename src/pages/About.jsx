          ...
          <div data-aos="fade-up">
            ...
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-3xl font-[Battambang] font-semibold">
                <span className="text-[#112d51]">អំពី</span>{" "}
                <span className="text-[#f49d0d]">ដំណាក់កាល</span>
              </h1>
            </div>
              ...
              <SectionTitle
                title={
                  <>
                    ...
                    <span className="text-[#f49d0d] font-semibold">ដ៏ល្អ</span>
                    <span className="text-[#073170] dark:text-white font-semibold">
                      របស់យើង
                    </span>
                  </>
        ...
        <div className="rounded-3xl bg-white dark:bg-[#1c293e] p-6 shadow-sm ring-1 ring-slate-200 dark:ring-[#314057] md:p-10">
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-2 font-[Battambang]">
            ...
            >
              ...
              <button
                type="button"
                className="mt-4 w-full rounded-lg bg-[#395f99] px-4 py-2 text-base text-white shadow-sm hover:bg-[#395f99]"
              >
                ផ្ញើសារ
              </button>
            </form>
            ...
            <div className="" data-aos="fade-left">
              ...
              <div className="mt-5 space-y-3 text-base text-slate-700 ">
                ...
                <div>
                  ...
                  <p className="mt-4 font-semibold dark:text-[#fcfcfc]">តាមដានខ្ញុំ</p>

  ...
  return (
    ...
    <>
      <div className="min-h-screen bg-[#f3f4f6] px-4 sm:px-8 md:px-16 lg:px-40 py-10 sm:py-14 md:py-16">
        ...
        {/* Announcement Box */}
        <div
          className="bg-[#dfe6f4] rounded-xl p-6 flex flex-col md:flex-row justify-between items-center mb-10"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          ...
          <button className="bg-[#e1f6e5] text-green-700 border border-green-500 px-6 sm:px-8 py-2 sm:py-3 rounded-xl hover:bg-green-300 transition-all font-semibold w-full md:w-auto inline-block text-center">
            ចុះឈ្មោះ
          </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Right Big Card */}
          <div
            className="md:col-span-2 bg-white rounded-xl p-6 shadow-sm min-h-[400px]"
            data-aos="fade-up"
            data-aos-delay="300"
          >
            {/* Tabs */}
            <div className="flex gap-4 mb-8">
              ...
              <Link
                to="/learnbeforelogin"
                className="bg-[#d9d9d9] text-[#6c7080] border border-[#6c7080] px-6 py-2 rounded-lg font-medium"
              >
                បានបញ្ចប់
              </Link>
            </div>

...
const HeroSection = () => {
  return (
    <section 
      className="relative flex min-h-125 w-full items-center justify-center overflow-hidden bg-[#0a192f] py-20 lg:min-h-150"
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-sm leading-relaxed text-gray-200 opacity-90 md:text-lg lg:text-xl">
          វគ្គសិក្សាដែលចាប់ផ្ដើមពីមូលដ្ឋានទៅជំនាញខ្ពស់ សម្រួលសម្រាប់ អ្នកដែលចាប់ផ្ដើមរៀនថ្មី 
          និងអនុវត្តដោយសមត្ថភាពជាក់ស្ដែង
        </p>

        {/* Call to Action Button */}
        <div className="mt-10">
          <Link to="/signup" className="rounded-lg bg-[#FFA500] px-10 py-3 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-[#e8940d] active:scale-95">
            ចាប់ផ្ដើមរៀន
          </Link>
        </div>

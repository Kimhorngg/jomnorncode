  ...
  const roadmapData = {
    web: {
      steps: [
        {
          id: 1,
          title: "រៀន HTML, CSS, JavaScript",
          desc: "យល់ពីមូលដ្ឋាននៃការបង្កើតវេបសាយ។",
        },
        {
          id: 2,
          title: "សិក្សា Framework (React/Vue)",
          desc: "បង្កើតកម្មវិធីវេបសាយឱ្យមានលក្ខណៈរស់រវើក។",
        },
        {
          id: 3,
          title: "រៀន Backend (Node.js, Express)",
          desc: "គ្រប់គ្រងទិន្នន័យ និង API។",
        },
        {
          id: 4,
          title: "អនុវត្តគម្រោងជាក់ស្តែង",
          desc: "អភិវឌ្ឍន៍ Portfolio ឬវេបសាយផ្ទាល់ខ្លួន។",
        },
      ],
    },
    mobile: {
      steps: [
        {
          id: 1,
          title: "រៀន Dart & Flutter",
          desc: "ស្វែងយល់ពីការបង្កើត UI សម្រាប់ Mobile។",
        },
        {
          id: 2,
          title: "State Management",
          desc: "ការគ្រប់គ្រង Data ក្នុង App ធំៗ (Provider/Riverpod)។",
        },
        {
          id: 3,
          title: "Native Features",
          desc: "ប្រើប្រាស់ Camera, GPS និង Push Notifications។",
        },
        {
          id: 4,
          title: "App Store Deployment",
          desc: "របៀបដាក់ App លើ Play Store និង App Store។",
        },
      ],
    },
    software: {
      steps: [
        {
          ...
          desc: "ពង្រឹងមូលដ្ឋានគ្រឹះនៃការដោះស្រាយបញ្ហា។",
        },
        {
          id: 2,
          title: "System Design",
          desc: "រចនាសម្ព័ន្ធ Software ខ្នាតយក្ស និង Scalability។",
        },
        {
          id: 3,
          title: "Database Architecture",
          desc: "ការប្រើប្រាស់ SQL និង NoSQL ឱ្យមានប្រសិទ្ធភាព។",
        },
        {
          id: 4,
          title: "DevOps & Cloud",
          desc: "រៀនអំពី Docker, Kubernetes និង Cloud Services។",
        },
      ],
    },
  };

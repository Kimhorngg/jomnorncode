      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] relative border border-gray-100 dark:bg-[#111827] dark:border-slate-800">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400 dark:text-slate-400 text-sm">Project Manager</p>
              </div>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] relative border border-gray-100 dark:bg-[#111827] dark:border-slate-800">
            ...
            <p className="text-[#6c7180] dark:text-slate-300 leading-relaxed">វេបសាយមាន Editor ដែលខ្ញុំអាចវាយកូដ និងមើលលទ្ធផលភ្លាមៗ។ទាំងស្រុង វេបសាយនេះធ្វើឲ្យការរៀនកូដក្លាយជារឿងងាយស្រួល សប្បាយ និងអាចប្រើបានទាំងពីរភាសា។
            </p>
          </div>
        </div>
      </div>

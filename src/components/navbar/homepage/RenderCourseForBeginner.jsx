...
export default function RenderCourseForBeginner() {
  return (
    <>
      {/* Section Header */}
      <div className="dark:bg-[#0e172b]">
        <div className="max-w-420 mt-10 mx-auto px-6 lg:px-12">
          <div
            className="flex justify-between items-center mb-16 gap-4 flex-wrap"
            data-aos="fade-up"
          >
            <div className="flex-1 min-w-[200px]">
              <h2 className="text-3xl md:text-4xl font-bold text-[#112d4f] flex items-center gap-2">
            ...
            {/* <Link
              to="/course"
              className="bg-[#3f72af] border-2 border-gray-500 hover:bg-[#0e468b] text-white text-base sm:text-lg font-semibold px-8 py-4 sm:px-10 sm:py-5 rounded-xl transition-all whitespace-nowrap"
            >
              មើលបន្ថែម
            </Link> */}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
            {/* Card 1 */}
            <div
              className="bg-white w-full rounded-2xl shadow-lg pt-10 pb-10 px-6 text-center relative min-h-[20rem]"
              data-aos="fade-up"
              data-aos-delay="0"
            >
              ...
              <h1 className="text-2xl md:text-3xl font-semibold text-blue-900 mt-6">
                HTML
              </h1>

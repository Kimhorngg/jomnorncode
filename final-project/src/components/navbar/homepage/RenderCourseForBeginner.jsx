  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-16  gap-4 px-6 sm:px-10  flex-wrap dark:bg-[#0e172b]">
        <div className="flex-1 min-w-[200px] md:pl-15">
          <h2 className="text-3xl md:text-4xl font-black text-[#112d4f] lg:pl-8 flex items-center gap-2">
        ...
        <button className="bg-[#3f72af] md:mr-24 border-2 border-gray-500 hover:bg-[#0e468b] text-white text-base sm:text-lg font-semibold px-8 py-4 sm:px-10 sm:py-5 rounded-xl transition-all whitespace-nowrap">
          មើលបន្ថែម
        </button>
      </div>

      {/* Cards Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-30 px-4  md:px-33 dark:bg-[#0e172b]">
        {/* Card 1 */}

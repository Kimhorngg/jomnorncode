            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="text-center lg:text-left lg:pl-8 xl:pl-16">
                ...
                <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 sm:gap-5 mb-12">
                 <Link
  to="/course"
  className="inline-block bg-[#0e468b] hover:bg-[#16a34a] text-white text-base sm:text-lg font-semibold px-8 py-4 sm:px-10 sm:py-5 rounded-xl transition-all shadow-lg shadow-green-900/40 transform hover:scale-105"
>
  មេីលវគ្គសិក្សា &gt;
</Link>

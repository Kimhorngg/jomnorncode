    ...
    <div className="min-h-screen bg-[#f3f4f6] px-4 sm:px-8 md:px-16 lg:px-40 py-10 sm:py-14 md:py-16">
      ...
      <div className="mb-8 sm:mb-10 text-center md:text-left">
       <h1 className="text-3xl md:text-4xl font-bold text-[#1e293b]">
        ...
        <p className="text-gray-500 mt-4 text-sm sm:text-base max-w-xl mx-auto md:mx-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div className="bg-white rounded-xl p-5 sm:p-6 shadow-sm">
          <h2 className="text-base sm:text-lg font-black text-[#112d4f] mb-5">
          ...
          <div className="flex justify-between flex-wrap gap-2">
            {["M", "T", "W", "T", "F", "S", "S"].map((day, index) => (
              <div
                key={index}
                className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-[#3f72af] text-white font-semibold text-sm sm:text-base"
              >
                {day}
              </div>
            ))}
        ...
        <div className="md:col-span-2 bg-white rounded-xl p-5 sm:p-6 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
            <button className="bg-[#98bae3] text-[#3f72af] border border-[#3f72af] px-4 sm:px-6 py-2 rounded-lg font-medium w-full sm:w-auto">
              កំពុងដំណេីរការ
            </button>
